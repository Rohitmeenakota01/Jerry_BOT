...
auth_channel = environ.get('-1002210715629')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Jerry Movies™](https://t.me/jerry_movies)</b>⚡\n\n📂 <b>File Name: </b>{file_name} \n⚙️ <b>Size: </b><i>{file_size}</i>\n\n❤")
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','jerry_movies') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Rohitmeena_official') # WITHOUT @
